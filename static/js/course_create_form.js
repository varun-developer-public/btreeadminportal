    ...
    function updateTotalDuration() {
        ...
        if (courseTotalDuration > 0) {
            if (totalHours !== courseTotalDuration) {
                validationMessageDiv.innerHTML = `<strong>Validation Error:</strong> The sum of module durations (<strong>${totalHours}</strong> hours) must equal the total course duration (<strong>${courseTotalDuration}</strong> hours).`;
                validationMessageDiv.className = 'alert alert-danger p-2 mt-3';
                validationMessageDiv.style.display = 'block';
                saveButton.disabled = true;
            } else {
                validationMessageDiv.innerHTML = '<strong>Success:</strong> Module durations match the total course duration.';
                validationMessageDiv.className = 'alert alert-success p-2 mt-3';
